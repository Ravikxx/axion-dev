...
export const COMMANDS = [
  ...
  { cmd: 'thinking',    desc: '[on|off|<tokens>]  toggle extended thinking (all models)' },
  { cmd: 'adviser',     desc: '[model|auto|off]  set adviser model for when agent gets stuck' },
  ...
  { cmd: 'compare-models', desc: '[m1,m2,...]  get/set default models for /compare' },
  ...
  { cmd: 'mcp',         desc: 'status · add · remove · tools · reload  (MCP servers)' },
